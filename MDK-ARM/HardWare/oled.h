...
*/
#define OLED_SCLK_Clr() HAL_GPIO_WritePin(GPIOD, 1,GPIO_PIN_RESET)//SCL
#define OLED_SCLK_Set() HAL_GPIO_WritePin(GPIOD, 1,GPIO_PIN_SET)//SCL

#define OLED_SDIN_Clr() HAL_GPIO_WritePin(GPIOD, 2,GPIO_PIN_RESET)//SCL
#define OLED_SDIN_Set() HAL_GPIO_WritePin(GPIOD, 2,GPIO_PIN_SET)//SCL
